classdef nn_My_SincNet_Layer < nnet.layer.Layer
    ...
    methods
        function layer = nn_My_SincNet_Layer(NumFilters, FilterLength, SampleRate, NumChannels, Name)
            ...
            layer.Description = "Sinc Layer with " + NumFilters + " filters";
        ...
        function Z = predict(layer, X)
            ...
            Filters = reshape(F,layer.FilterLength,1,1,layer.NumFilters);
            % Convolve input with sinc filters
            Z = dlconv(X,Filters,0,'DataFormat','SSCB','Padding','same');
        end
